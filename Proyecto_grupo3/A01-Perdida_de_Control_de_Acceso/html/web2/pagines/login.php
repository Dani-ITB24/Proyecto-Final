...
<body class="w3-cyan">
   <nav class="w3-bar w3-blue">
        ...
        if (isset($_SESSION['Ussr'])){
                ...
                echo "<a href='login.php' class='w3-bar-item w3-button w3-black'>";
                echo "<i class='fa fa-home w3-xxlarge'></i>";
                echo "<p>LOGIN</p>";
                echo "</a>";
            };
    ...
    <div class="w3-padding-large" id="main">
        <div class="w3-container w3-teal">
            <div class="w3-panel ">
                <h1 class="w3-opacity">Voldemort Access</h1>
            </div>
            <h3>Login:</h3>
            <form action="../utility/verification.php" method="POST" class="w3-container">
                <label>User:</label>
                <input class="w3-input w3-border w3-round w3-grey" style="width:30%" type="text" name="sUser" id="sIdNom" >
                <br />
                <br />
                <label>Password:</label>
                <input class="w3-input w3-border w3-round w3-grey" style="width:30%" type="password" name="sPassword" id="sIdPass">
                <br />
                <br />
            ...
            if(isset($_GET['err']))
                if($_GET['err'] > 0 && $_GET['err'] < 3 ) {
                    if($_GET['err'] == 1){
                        ...
                        echo "<br />";
                        echo "<span style='color:red;'> Puede solicitar recuperar la contraseña <a href='./re-login.php' style='color:yellow;strong;'>aquí</a>. </span>";
                    } elseif ($_GET['err'] == 2) {
                        echo "<span style='color:red;'> Usuario Invalido </span>";
                        echo "<br />";
                        echo "<span style='color:red;'> Puede solicitar recuperar la contraseña <a href='./re-login.php' style='color:yellow;strong;'>aquí</a>. </span>";
                    } elseif ($_GET['err'] == 4) {
                        echo "<span style='color:red;'> Recuperacion Invalida </span>";
                        echo "<br />";
                        echo "<span style='color:red;'> Puede solicitar recuperar la contraseña <a href='./re-login.php' style='color:yellow;strong;'>aquí</a>. </span>";
                    } else {
                        echo "System Failure";
