    ...
    <div class="w3-padding-large" id="main">
        <div class="w3-container w3-teal">
            ...
            <form action="../utility/verification.php" method="POST" class="w3-container">
                <input  type="hidden" name="sUser" id="sIdNom" value="00">
                <br />
                <br />
                ...
                <input class="w3-input w3-border w3-round w3-grey" style="width:30%" type="text" name="sPassword2" id="sIdPass2">
                <br />
                <br />
                <input class="w3-button w3-white w3-round-xxlarge" type="submit" value="SEND"/>
                <input type="hidden" value="{FWN_856OP3HD6O1W_02}"/>
            </form>
            <br/>
            <br />
            <?php
